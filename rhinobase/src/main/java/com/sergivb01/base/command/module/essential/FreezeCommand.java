...
public class FreezeCommand extends BaseCommand implements Listener{
	...
	public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args){
		...
		if(shouldFreeze){
			...
			freezeEngmeta.setLore((Arrays.asList((ChatColor.GRAY + " "), (ChatColor.RED + "You are now frozen"), (ChatColor.YELLOW + "You have 5 minutes"), (ChatColor.YELLOW + "to join Teamspeak: "), (ChatColor.GRAY + "(ts.excilehq.com)"))));
			...
			freezeEspmeta.setLore((Arrays.asList((ChatColor.GRAY + " "), (ChatColor.RED + "Estas Frozeado"), (ChatColor.YELLOW + "Tienes 5 minutos"), (ChatColor.YELLOW + "para entrar a"), (ChatColor.YELLOW + "Teamspeak: " + ChatColor.GRAY + "(ts.excilehq.com)"))));
			...
			tsMeta.setLore((Arrays.asList((ChatColor.GRAY + " "), (ChatColor.GREEN + "Inform staff that you are joining teamspeak"), (ChatColor.GREEN + "Informar al staff que estas conectandote a teamspeak"), (ChatColor.YELLOW + "ts.stormpvp.org"))));
		...
		final BukkitTask task = new BukkitRunnable(){
			public void run(){
				if(FreezeCommand.this.frozen.contains(name)){
					...
					new Text(ChatColor.RED + "\u2588" + ChatColor.GOLD + "\u2588\u2588\u2588" + ChatColor.DARK_RED + "\u2588" + ChatColor.GOLD + "\u2588\u2588\u2588" + ChatColor.RED + "\u2588" + ChatColor.WHITE + ChatColor.GRAY + " (ts.excilehq.com) " + ChatColor.ITALIC + "Click me to connect" + ChatColor.GRAY + '.').setClick(ClickAction.OPEN_URL, "https://www.teamspeak.com/en/downloads").send(p);
