...
public class HCF extends JavaPlugin implements PluginMessageListener{
	...
	public void onEnable(){
		...
		Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', "&d[HCF] &7|- Plugin has been enabled"));
		Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', "&d[HCF] &7|- &bVersion: &f" + HCF.getPlugin().getDescription().getVersion()));
